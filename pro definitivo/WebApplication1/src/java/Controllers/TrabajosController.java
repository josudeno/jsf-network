...
@ManagedBean(name = "trabajosController")
@SessionScoped
public class TrabajosController implements Serializable {
    ...
    @EJB
    private DAO.TrabajosFacade ejbFacade;
    ...
    public static class TrabajosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Trabajos) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TrabajosController.class.getName());
            }
        }
    }
}
